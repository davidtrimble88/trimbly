  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <KPI label="MRR" value={money(t.mrr)} sub={`${money(t.mrr_homeowners)} HO · ${money(t.mrr_providers)} Pro`} icon={DollarSign} accent="bg-green-500/10 text-success" />
      ...
      <Tabs defaultValue="subscriptions" className="space-y-4">
        ...
        <TabsContent value="money" className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <KPI label="GMV bids accepted" value={money(t.gmv_bids_accepted)} sub={`${num(t.accepted_bids)} accepted`} icon={Briefcase} accent="bg-green-500/10 text-success" />
