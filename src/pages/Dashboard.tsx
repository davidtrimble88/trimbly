    ...
    <div className="min-h-screen bg-background flex flex-col">
      <OnboardingTour
        ...
        steps={[
          ...
          { title: "Upgrade Anytime", body: "Free covers the basics. Upgrade to Home Hero for unlimited estimates, AI tools, and binder items, or Multi-Home Hero to manage up to 10 properties." },
        ]}
      />
      <Navbar />
