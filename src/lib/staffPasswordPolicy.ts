// Password policy for staff/employee accounts (Team.tsx + create-staff-account
// edge function both enforce this — client-side is UX only, the edge function
// copy of this logic is the real security boundary since it runs server-side).
