            ...
            function: {
              ...
              parameters: {
                ...
                properties: {
                  ...
                  field_confidence: {
                    type: "object",
                    description: "Per-field confidence. Use 'low' whenever the value was inferred, guessed, partially cut off, hard to read, missing, or the report only implies it. Use 'medium' for values that are readable but slightly ambiguous (e.g. handwritten, smudged, unclear units). Use 'high' only when the value is printed clearly and unambiguously on the document.",
                    properties: {
                      service_date: { type: "string", enum: ["high", "medium", "low"] },
                      mileage: { type: "string", enum: ["high", "medium", "low"] },
                      service_type: { type: "string", enum: ["high", "medium", "low"] },
                      shop_name: { type: "string", enum: ["high", "medium", "low"] },
                      total_cost: { type: "string", enum: ["high", "medium", "low"] },
                      next_service_date: { type: "string", enum: ["high", "medium", "low"] },
                      next_service_mileage: { type: "string", enum: ["high", "medium", "low"] },
                    },
                    required: [
                      "service_date", "mileage", "service_type", "shop_name",
                      "total_cost", "next_service_date", "next_service_mileage",
                    ],
                ...
                required: [
                  ...
                  "next_service_notes", "technician_notes", "confidence", "field_confidence",
                ],
                additionalProperties: false,
              },
            },
